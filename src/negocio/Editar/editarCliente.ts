...
export default class editarCliente extends Editar {
    ...
    public editar() {
        ...
        if (index !== -1) {
            ...
            let genero = this.entrada.receberTexto(`Por favor informe o gênero (Masculino/Feminino): `)
            ...
            let adicionarTelefone: boolean = this.entrada.receberTexto(`Deseja adicionar um novo telefone? (sim/nao): `).toLowerCase() === 'sim';
            if (adicionarTelefone) {
                ...
                this.clientes[index].addTelefones(telefones);
            }
