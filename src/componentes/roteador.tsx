...
import RegistrarVendaProduto from "./Registros/RegistrarVendaProduto";
...
export default class Roteador extends Component<{}, state>{
    ...
    render() {
        let barraNavegacao = <BarraNavegacao seletorView={this.selecionarView} tema="#e3f2fd" botoes={['Início','Listar','Cadastrar', 'Registrar Venda']} />
        ...
        if(this.state.tela === 'Registrar Venda'|| this.state.tela === 'Registrar venda produto'){
            let barraRegistro = <BarraNavegacao seletorView={this.selecionarView} tema="#e3f2fd" botoes={['Início','Registrar venda produto', 'Registrar venda serviço']} />
            return(
                <>
                    {barraRegistro}
        ...
        if(this.state.tela === 'Registrar venda serviço'){
            let barraRegistro = <BarraNavegacao seletorView={this.selecionarView} tema="#e3f2fd" botoes={['Início','Registrar venda produto', 'Registrar venda serviço']} />
            return(
                <>
                    {barraRegistro}
